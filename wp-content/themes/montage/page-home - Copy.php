...
get_header(); ?>
        ...
        $(window).load(function(){
          $('.home-slider-container').flexslider({
            ...
            start: function(slider){
              ...
              $('.home-slider-container .slider-nav-showreel111').css({display:'block'});
            }
          });
        });        
    </script>
    <div class="home-slider-outer-container">
        ...
        <?php endwhile; ?>
        <?php
         $home_slides = new WP_Query( array('cat' => 15,'meta_key'=>'display_in_home_gallery',
                                            'meta_value' => '1',
                                            'meta_compare' => '==',
                                            'order' => 'DESC') );
                while ($home_slides->have_posts()) : $home_slides->the_post();
	...
	<div class="wrapper relative clear">
    	<h1 class="page-title">
        	<span class="title" title="<?php echo $news_home_block_title; ?>"><?php echo $news_home_block_title; ?></span>
        </h1>
