...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		//'comment_notes_after'  => '<p class="form-allowed-tags" style="display:none;">' . sprintf( __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ), ' <code>' . allowed_tags() . '</code>' ) . '</p>',
		'comment_notes_after'  => '',
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
